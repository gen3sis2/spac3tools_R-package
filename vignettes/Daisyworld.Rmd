...
config_file <- system.file(file.path("extdata/Daisyworld/config_daisyworld"), package="spac3tools")
...
gen3sis2::run_simulation(config = config_obj, landscape = file.path(dirs$input, "spaces.rds"), output_directory = dirs$output)
```
